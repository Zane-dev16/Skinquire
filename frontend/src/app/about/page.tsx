  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.aboutSection}>
        ...
        <p className={styles.aboutText}>
          Like many of you, we've been there – spending hours online, searching
          for the perfect skincare products amidst a sea of conflicting
          opinions. It became clear that there was a need for a reliable source
          of information, just like IMDb helps us find the best movies. And so,
          Skinquire.net was born – a platform dedicated to providing you with
          accurate and community-driven skincare product ratings.
        </p>
      </div>
      <div className={styles.aboutSection}>
      ...
      <div className={styles.aboutSection}>
        ...
        <p className={styles.aboutText}>
          ...
          transparency means you're getting the real scoop on what works and
          what doesn't.
        </p>
      </div>
      <div className={styles.aboutSection}>
        ...
        <p className={styles.aboutText}>
          Navigating the world of skincare can be overwhelming, but it doesn't
          have to be. At Skinquire.net, we've curated a diverse range of
          products, each with a reliable rating and review to guide you. Whether
          you're looking to address specific concerns or simply enhance your
          skincare routine, we're here to make your journey smoother.
        </p>
      </div>
      <div className={styles.aboutSection}>
        <h2 className={styles.aboutSubheading}>Join Our Community</h2>
        <p className={styles.aboutText}>
          We're more than just a ratings platform – we're a vibrant community of
          skincare enthusiasts. Share your experiences, connect with like-minded
          individuals, and contribute to a knowledge hub that's fueled by the
          passion for healthier, glowing skin.
        </p>
      </div>
      <div className={styles.aboutSection}>
        <h2 className={styles.aboutSubheading}>Get Involved</h2>
        <p className={styles.aboutText}>
          Ready to embark on your skincare journey with us? Here's how you can
          get started:
        </p>
      ...
      <p className={styles.aboutText}>
        At Skinquire.net, we're excited to be your skincare companion, offering
